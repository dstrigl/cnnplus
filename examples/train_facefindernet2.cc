/**************************************************************************//**
 *
 * \file   train_facefindernet2.cc
 * \author Daniel Strigl, Klaus Kofler
 * \date   Nov 26 2009
 *
 * $Id: train_facefindernet2.cc 3167 2010-01-06 17:48:31Z dast $
 *
 *****************************************************************************/
...
int main(int argc, char *argv[])
{
    ...
    try {
        ...
        facesTrain.load(argv[2], "x_test", "d_test");
        facesTst.load(argv[1], "x", "d");
        CNNPLUS_ASSERT(facesTrain.size() == 10000 && facesTst.size() == 2000);

        // Use 1000 samples (10%) of the training-set for validation
        SubsetDataSrc<DataType> facesTrn(facesTrain,    0, 9000);
        SubsetDataSrc<DataType> facesVal(facesTrain, 9000, 1000);
        ...
        //trainer.writeRocPoints(facesTrn, "rocTrn.mat");
        //trainer.writeRocPoints(facesVal, "rocVal.mat");
        //trainer.writeRocPoints(facesTst, "rocTst.mat");
        //trainer.writeConfMatrix(facesTrn, 2, "confMtxTrn.mat");
        //trainer.writeConfMatrix(facesVal, 2, "confMtxVal.mat");
        //trainer.writeConfMatrix(facesTst, 2, "confMtxTst.mat");
