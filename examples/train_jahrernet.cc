/**************************************************************************//**
 *
 * \file   train_jahrernet.cc
 * \author Daniel Strigl, Klaus Kofler
 * \date   Jun 30 2009
 *
 * $Id: train_jahrernet.cc 2868 2009-12-07 20:06:25Z dast $
 *
 *****************************************************************************/
...
int main(int argc, char *argv[])
{
    ...
    try {
        ...
        MnistMemSource<DataType> mnistTrain(Size(28, 28));
        MnistMemSource<DataType> mnistTst(Size(28, 28));
